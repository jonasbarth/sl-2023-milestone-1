...
The main goal of this project is to predict the amount of **accumulated delay** on a public transport route operated by ATAC in the city of Rome. Public transport in Rome is notoriously underdeveloped and faces many problems from procurement corruption [@de_santis_2022] to spontaneously combusting buses [@agi_2021] and Russian hacker attacks [@russian_hacker_roma_today_2023]. Still, hundreds of thousands of Romans rely on ATAC and its busses, trams, and metros to get them to their destinations, every day. 
